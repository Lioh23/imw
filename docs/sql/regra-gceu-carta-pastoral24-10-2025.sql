INSERT INTO `regras` (`id`, `nome`, `created_at`, `updated_at`, `deleted_at`) VALUES (NULL, 'gceu-carta-pastoral', current_timestamp(), current_timestamp(), NULL);
...
FROM regras r
WHERE r.nome = 'gceu-carta-pastoral'
ORDER BY r.id DESC
LIMIT 1;
