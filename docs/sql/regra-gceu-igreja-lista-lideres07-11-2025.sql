INSERT INTO `regras` (`id`, `nome`, `created_at`, `updated_at`, `deleted_at`) VALUES (NULL, 'gceu-igreja-lista-lideres', current_timestamp(), current_timestamp(), NULL);
...
FROM regras r
WHERE r.nome = 'gceu-igreja-lista-lideres'
ORDER BY r.id DESC
LIMIT 1;
