  <div class="tab-pane fade show active" id="border-top-dados-pessoal" role="tabpanel" aria-labelledby="border-top-dados-pessoais">
    ...
    <div class="row mb-4">
      ...
      <div class="col-xl-3 text-center">
        ...
        <img src="{{ old('foto') ? asset(old('foto')) : 'https://via.placeholder.com/150' }}" id="user-picture" class="rounded-circle img-fluid mb-3" alt="Foto do usuário" width="150px" height="150px;">
        <div>
          ...
          <div class="form-group @error('nome') has-error @enderror">
              ...
              <div class="col-xl-3">
                ...
                <select class="form-control @error('estado_civil') is-invalid @enderror" id="nacionalidade" name="nacionalidade">
                  ...
                  @foreach ($paises as $sigla => $nome)
                    <option value="{{ $sigla }}" {{ old('nacionalidade') == $sigla ? 'selected' : '' }}>{{ $nome }}</option>
                  @endforeach
                </select>
                @error('nacionalidade')
                  <span class="help-block text-danger">{{ $message }}</span>
              ...
              <div class="col-xl-3">
                ...
                <select class="form-control @error('uf') is-invalid @enderror" id="uf" name="uf">
                  ...
                  @foreach ($ufs as $key => $value)
                    <option value="{{ $key }}" {{ (old('uf') == $key) ? 'selected' : '' }}>{{ $value }}</option>
                  @endforeach
                </select>
                @error('uf')
                <span class="help-block text-danger">{{ $message }}</span>
            ...
            <div class="row mb-4">
                ...
                <select class="form-control" name="escolaridade_id" id="escolaridade_id">
                  ...
                  @foreach ($formacoes as $formacao)
                      <option value="{{ $formacao->id }}"
                        {{ $formacao->id == old('escolaridade_id') ? 'selected' : '' }}>
                        {{ $formacao->descricao }}
                      </option>
                  @endforeach
                </select>
              ...
              <div class="col-xl-3">
                ...
                <input type="text" class="form-control" id="profissao" name="profissao" value="{{ old('profissao') }}" >
                @error('profissao')
                  <span class="help-block text-danger">{{ $message }}</span>
                @enderror
              </div>
                ...
                <select class="form-control" name="funcao_eclesiastica_id" id="funcao_eclesiastica_id">
                  ...
                  @foreach ($funcoesEclesiasticas as $funcaoEclesiastica)
                      <option value="{{ $funcaoEclesiastica->id }}"
                        {{ $funcaoEclesiastica->id == old('funcao_eclesiastica_id') ? 'selected' : '' }}>
            ...
            <div class="row mb-4">
              <div class="col-xl-4">
                ...
                <input type="date" class="form-control @error('data_conversao') is-invalid @enderror" id="data_conversao" name="data_conversao" value="{{ old('data_conversao') }}">
              ...
              <div class="col-xl-4">
                ...
                <input type="date" class="form-control @error('data_batismo') is-invalid @enderror" id="data_batismo" name="data_batismo" value="{{ old('data_batismo') }}">
                @error('data_batismo')
                  <span class="help-block text-danger">{{ $message }}</span>
                @enderror
              </div>
              ...
              <div class="col-xl-4">
                ...
                <input type="date" class="form-control @error('data_batismo_espirito') is-invalid @enderror" id="data_batismo_espirito" name="data_batismo_espirito" value="{{ old('data_batismo_espirito') }}">
