                      ...
                      <div class="row mb-4">
                          ...
                          <div class="col-xl-3">
                              ...
                              <input type="date" class="form-control @error('data_nascimento') is-invalid @enderror"
                                  ...
                                  value="{{ old('data_nascimento', $pessoa->data_nascimento) }}" min="1900-01-01">
                          ...
                          <div class="col-xl-3">
                              ...
                              <select class="form-control @error('estado_civil') is-invalid @enderror"
                                  ...
                                  @foreach ($paises as $sigla => $nome)
                                      <option value="{{ $sigla }}"
                                          {{ old('nacionalidade', $pessoa->nacionalidade) == $sigla ? 'selected' : '' }}>
                                          {{ $nome }}</option>
                                  @endforeach
                              </select>
                              @error('nacionalidade')
                          ...
                          <div class="col-xl-3">
                              ...
                              <select class="form-control @error('uf') is-invalid @enderror" id="uf"
                                  ...
                                  @foreach ($ufs as $key => $value)
                                      <option value="{{ $key }}"
                                          {{ old('uf', $pessoa->uf) == $key ? 'selected' : '' }}>{{ $value }}
                                      </option>
                                  @endforeach
                              </select>
                              @error('uf')
                      ...
                      <div class="row mb-4">
                          ...
                          <div class="col-xl-4">
                              ...
                              <input type="date"
                                  ...
                                  value="{{ old('data_batismo_espirito', $pessoa->data_batismo_espirito) }}">
                      ...
                      <div class="row mb-4">
                          ...
                          <div class="form-group mb-4 col-md-6">
                                ...
                                <select id="congregacao_id" name="congregacao_id" class="form-control @error('congregacao_id') is-invalid @enderror" >
                                    <option value="" {{ !$pessoa->congregacao_id ? 'selected' : '' }}>Selecione</option>
