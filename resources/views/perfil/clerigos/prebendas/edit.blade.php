...
@section('breadcrumb')
    <x-breadcrumb :breadcrumbs="[
        ...
        ['text' => 'Editar Prebenda', 'url' => '', 'active' => true],
    ]"></x-breadcrumb>
@endsection
    ...
    <div class="col-lg-12 col-12 layout-spacing">
        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <form class="form-vertical" action="{{ route('clerigos.perfil.prebendas.update', $prebenda->id) }}"
                    method="POST">
                    @csrf
                    <div class="row">
...
@section('extras-scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (anoSelecionado) {
                pegarValorMaxPrebenda(anoSelecionado);
                calcularPrebendasPorAno(anoSelecionado);
            }
