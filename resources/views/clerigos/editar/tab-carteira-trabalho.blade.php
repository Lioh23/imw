    ...
    <blockquote class="blockquote">
        <div class="row">
            ...
            <div class="col-12 mt-3 col-md-4">
                ...
                <input type="date" class="form-control @error('ctps_emissao') is-invalid @enderror" id="ctps_emissao"
                    name="ctps_emissao" value="{{ old('ctps_emissao', $clerigo->ctps_emissao) }}" >
                @error('ctps_emissao')
                    <span class="help-block text-danger">{{ $message }}</span>
                @enderror
            </div>
