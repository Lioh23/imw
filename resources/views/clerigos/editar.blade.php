...
@section('content')
    ...
    <form class="py-2 px-3" method="POST" action="{{ route('clerigos.update', $clerigo->id) }}">
        @csrf
        @method('PUT')
        ...
        <div id="tab_endereco" class="mt-4">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-3 col-md-4">
                    ...
                    <input type="text" class="form-control" id="telefone_preferencial" name="telefone_preferencial"
            ...
            <div class="row">
                ...
                <div class="col-12 mt-3 col-md-4">
                    ...
                    <select class="form-control" type="text" id="habilitacao_categoria" name="habilitacao_categoria">
                        <option value="ACC"{{ $clerigo->habilitacao_categoria == 'ACC' ? 'selected' : 'ACC' }}>A
                        </option>
