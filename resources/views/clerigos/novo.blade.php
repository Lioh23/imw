                ...
                <div class="row">
                    <div class="col-12 mt-3 col-md-4">
                        ...
                        <select class="form-control" type="text" id="estado_civil" name="estado_civil"
                            ...
                            <option value="1" {{ old('estado_civil') == 'solteiro' ? 'selected' : '' }}>Solteiro</option>
                            <option value="2" {{ old('estado_civil') == 'casado' ? 'selected' : '' }}>Casado</option>
                            <option value="3" {{ old('estado_civil') == 'divorciado' ? 'selected' : '' }}>Divorciado</option>
                            <option value="4" {{ old('estado_civil') == 'viuvo' ? 'selected' : '' }}>Viúvo</option>
                        </select>
            ...
            <div id="tab_endereco" class="mt-4">
                    ...
                    <div class="col-12 mt-3 col-md-4">
                        ...
                        <select class="form-control" type="text" id="uf" name="uf">
                            @foreach ($ufs as $sigla => $uf)
                                <option value="{{ $sigla }}" {{ old('uf') == $uf ? 'selected' : '' }}>{{ $uf }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="col-12 mt-3 col-md-3">
                        ...
                        <select class="form-control" type="text" id="pais" name="pais"  value="{{ old('pais') }}">
            ...
            <div id="tab_registro_geral">
                <div class="row">
                    <div class="col-12 mt-3 col-md-4">
                        ...
                        <input type="text" class="form-control" id="identidade" name="identidade"  value="{{ old('identidade') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                        <label for="data_emissao">Data de Emissão*</label>
                        <input type="date" class="form-control" id="data_emissao" name="data_emissao" value="{{ old('data_emissao') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                        <label for="orgao_emissor">Orgão Emissor*</label>
                        <input type="text" class="form-control" id="orgao_emissor" name="orgao_emissor" value="{{ old('orgao_emissor') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                        <label for="identidade_uf">Estado*</label>
                        <select class="form-control" type="text" id="identidade_uf" name="identidade_uf" >
                            @foreach ($ufs as $sigla => $uf)
                                <option value="{{ $sigla }}" {{old('identidade_uf') == $uf ? 'selected' : '' }}>{{ $uf }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div id="tab_carteira_trabalho">
                <div class="row">
                    <div class="col-12 mt-3 col-md-4">
                        ...
                        <input type="text" class="form-control" id="ctps" name="ctps" value="{{ old('ctps') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                        <label for="ctps_emissao">Data de Emissão da CTPS*</label>
                        <input type="date" class="form-control" id="ctps_emissao" name="ctps_emissao" value="{{ old('ctps_emissao') }}">
                    </div>
                    {{-- <div class="col-12 mt-3 col-md-4">
            ...
            <div id="tab_pis_pasep">
                <div class="row">
                    <div class="col-12 mt-3 col-md-4">
                        ...
                        <input type="text" class="form-control" id="pispasep" name="pispasep" value="{{ old('pispasep') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                        <label for="pispasep_emissao">Pis/Pasep Data de Emissão*</label>
                        <input type="date" class="form-control" id="pispasep_emissao" name="pispasep_emissao" value="{{ old('pispasep_emissao') }}">
                    </div>
                    {{-- <div class="col-12 mt-3 col-md-4">
            ...
            <div id="tab_eleitor">
                <div class="row">
                    <div class="col-12 mt-3 col-md-4">
                        ...
                        <input type="text" class="form-control" id="titulo_eleitor" name="titulo_eleitor" value="{{ old('titulo_eleitor') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                        <label for="titulo_eleitor_zona">Zona*</label>
                        <input type="text" class="form-control" id="titulo_eleitor_zona" name="titulo_eleitor_zona" value="{{ old('titulo_eleitor_zona') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                        <label for="titulo_eleitor_secao">Seção*</label>
                        <input type="text" class="form-control" id="titulo_eleitor_secao"
                            name="titulo_eleitor_secao" value="{{ old('titulo_eleitor_secao') }}">
                    </div>
                </div>
            </div>
            ...
            <div id="tab_habilitacao">
                <div class="row">
                    <div class="col-12 mt-3 col-md-4">
                        ...
                        <input type="text" class="form-control" id="habilitacao" name="habilitacao" value="{{ old('habilitacao') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                    ...
                    <div class="col-12 mt-3 col-md-4">
                        ...
                        <input type="text" class="form-control" id="habilitacao_emissor" name="habilitacao_emissor" value="{{ old('habilitacao_emissor') }}">
                    </div>
                    <div class="col-12 mt-3 col-md-4">
                        <label for="habilitacao_uf">Estado*</label>
                        <select class="form-control" type="text" id="habilitacao_uf" name="habilitacao_uf" >
                            @foreach ($ufs as $sigla => $uf)
                                <option value="{{ $sigla }}"  {{old('habilitacao_uf') == $uf ? 'selected' : ''}}>{{ $uf }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
