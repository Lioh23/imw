...
<x-breadcrumb :breadcrumbs="[
        ...
        ['text' => 'Igrejas', 'url' => '/igrejas-regiao', 'active' => false],
        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Relatório Movimento Diário - {{ $instituicao->nome }}</h4>
                </div>
            </div>
        </div>
            ...
            <form class="form-vertical" id="filter_form" method="GET">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-lg-6">
                        ...
                        <button id="btn_relatorio" data-url="{{ route('igrejas-regiao.movimento-diario-pdf', ['igreja' => $instituicao->id]) }}" type="button" class="btn btn-secondary btn ml-4">
...
<script>
    document.getElementById('btn_relatorio').addEventListener('click', function () {
        ...
        var url = `${$(this).data('url')}?dt_inicial=${dt_inicial}&dt_final=${dt_final}&caixa_id=${caixa_id}`;
