        ...
        <div class="mt-4">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input class="form-control @error('complemento') is-invalid @enderror" type="text" id="complemento"
                        name="complemento" value="{{ old('complemento', $instituicao['complemento']) }}">
                    @error('complemento')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
<script>
    ...
    function loadInstituicoesPai(tipo_instituicao_id) {
        ...
        if (instituicaoPaiSelecionada) {
            ...
            var instituicaoPaiId = {{ old('instituicao_pai_id', $instituicao['instituicao_pai_id'] ?? 'null') }};
            if (instituicaoPaiId) {
