    ...
    <form class="py-2 px-3" method="POST" action="{{ route('instituicoes-regiao.store') }}">
        ...
        <div class="row">
            ...
            <div class="col-md-3 form-group">
                ...
                <input class="form-control @error('cnpj') is-invalid @enderror" type="text" id="cnpj" name="cnpj" value="{{ old('cnpj') }}">
                @error('cnpj')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-3 form-group">
                ...
                <input class="form-control @error('data_abertura') is-invalid @enderror"
                    type="date"
                    id="data_abertura"
                    name="data_abertura"
        ...
        <div class="row">
            <div class="col-md-3 form-group">
                ...
                <select name="tipo_instituicao_id" id="tipo_instituicao_id" class="form-control @error('tipo_instituicao_id') is-invalid @enderror">
                    <option value="" disabled {{ !request('tipo_instituicao_id') ? 'selected' : '' }}>Selecione</option>
                    ...
                    <option value="5" {{ old('tipo_instituicao_id') == 5 ? 'selected' : '' }}>Secretaria Regional</option>
                </select>
        ...
        <div class="row">
            ...
            <div class="col-md-2 form-group">
                ...
                <input type="number" class="form-control @error('numero') is-invalid @enderror" id="numero" name="numero" value="{{ old('numero') }}">
                @error('numero')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-1 form-group">
                <label for="pais"><span>*</span> DDD</label>
                <input type="text" maxlength="3" class="form-control p-2 @error('ddd') is-invalid @enderror" id="ddd" name="ddd" value="{{ old('ddd') }}">
                @error('ddd')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-3 form-group">
                <label for="pais"><span>*</span> Telefone</label>
