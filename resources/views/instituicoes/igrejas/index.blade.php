                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                ...
                                                @if(!$igreja->deleted_at)
                                                <a href="javascript:void(0);" title="Visualizar" class="btn btn-sm btn-info mr-1 btn-rounded btn-view-details" data-igreja-id="{{ $igreja->id }}">
                                                ...
                                                <a href="{{ route('instituicoes.igrejas.editar', $igreja->id) }}" title="Editar" class="btn btn-sm btn-dark mr-1 btn-rounded">
                                                ...
                                                <form action="{{ route($igreja->deleted_at ? 'instituicoes.igrejas.ativar' : 'instituicoes.igrejas.deletar', $igreja->id) }}"
                                                    method="POST" style="display: inline-block;" id="form_{{ $igreja->deleted_at ? 'ativar' : 'delete' }}_igreja_{{ $index }}">
                                                    @csrf
                                                    @if($igreja->deleted_at)
                                                    @method('PUT') {{-- Para restaurar o registro --}}
                                                    <button type="button" title="Ativar" class="btn btn-sm btn-success mr-1 btn-rounded btn-confirm-ativar" data-form-ativar-id="form_ativar_igreja_{{ $index }}">
                                                    ...
                                                    @else
                                                    @method('DELETE')
                                                    <button type="button" title="Inativar" class="btn btn-sm btn-danger btn-rounded btn-confirm-delete" data-form-delete-id="form_delete_igreja_{{ $index }}">
                                        ...
                                        <div class="modal fade" id="viewDetailsModal_{{ $igreja->id }}" tabindex="-1" role="dialog" aria-labelledby="viewDetailsModalLabel_{{ $igreja->id }}" aria-hidden="true">
...
<script>
    ...
    $('.btn-view-details').on('click', function() {
        ...
        $.ajax({
            url: '/instituicoes/igrejas/' + igrejaId + '/detalhes',
            method: 'GET',
