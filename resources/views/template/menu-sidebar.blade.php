        ...
        <ul class="list-unstyled menu-categories" id="accordionExample" style="margin-top: -35px;">
            ...
            @if ($baseParams->notificacoesTransferencia->count())
                <li class="menu container-fluid">
                    <a href="{{ route('notificacoes-tranferencia.index') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <span class="badge-secondary" style="padding: 8px; border-radius: 12px;">Nova Notificação</span>
                        </div>
                    </a>
                </li>
            @endif
