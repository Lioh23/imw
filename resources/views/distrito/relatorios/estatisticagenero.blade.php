                                ...
                                <table class="table table-striped" style="font-size: 90%; margin-top: 15px;">
                                    <thead class="thead-dark">
                                        ...
                                        <tr>
                                            ...
                                            <th width="140px" style="text-align: left">{{ \Carbon\Carbon::parse(request()->input('data_inicial'))->format('d/m/Y') }}</th>
                                            <th width="140px" style="text-align: left">{{ \Carbon\Carbon::parse(request()->input('data_final'))->format('d/m/Y') }}</th>
                                            <th width="140px" style="text-align: left">{{ \Carbon\Carbon::parse(request()->input('data_inicial'))->format('d/m/Y') }}</th>
                                            <th width="140px" style="text-align: left">{{ \Carbon\Carbon::parse(request()->input('data_final'))->format('d/m/Y') }}</th>
                                            <th width="140px" style="text-align: left">{{ \Carbon\Carbon::parse(request()->input('data_inicial'))->format('d/m/Y') }}</th>
                                            <th width="140px" style="text-align: left">{{ \Carbon\Carbon::parse(request()->input('data_final'))->format('d/m/Y') }}</th>
