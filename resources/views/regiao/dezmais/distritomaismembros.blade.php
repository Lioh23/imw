...
@section('breadcrumb')
    <x-breadcrumb :breadcrumbs="[
        ...
        ['text' => '10+ Distrios em Números de Membros', 'url' => '#', 'active' => true],
    ]"></x-breadcrumb>
@endsection
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>10+ Distrios em Números de Membros- {{ $regiao->nome }}</h4>
                    </div>
                </div>
            </div>
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h6 class="mt-3 text-uppercase">10+ Distrios em Números de Membros -
                                        {{ $regiao->nome }}</h6>
                                        ...
                                        <table class="table table-striped" style="font-size: 90%; margin-top: 15px;">
                                            <thead class="thead-dark">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;">Quantide de Membros</th>
