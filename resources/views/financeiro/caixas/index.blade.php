                                        ...
                                        <td class="table-action">
                                            @if($caixa->tipo != 'P')
                                                <a href="#" title="editar"
                                                    ...
                                                    <form action="{{ route('financeiro.caixas.deletar', $caixa->id) }}" method="POST" style="display: inline-block;" id="form_delete_caixa_{{ $index }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" title="Apagar" class="btn btn-sm btn-danger mr-2 btn-rounded btn-confirm-delete" data-form-id="form_delete_caixa_{{ $index }}">
