...
{
    public static function fetch($dataInicial, $dataFinal, $distritoId, $igrejaId = null): array
    {
        $sliceSqlIgreja = ($igrejaId && $igrejaId != 'all')
            ? "AND ii.id = $igrejaId"
            : '';
