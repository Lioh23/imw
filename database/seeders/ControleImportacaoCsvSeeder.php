...
class ControleImportacaoCsvSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            [
                'alias' => 'pessoas_nomeacoes',
                'file' => 'csv/pessoas_nomeacao.csv',
                'static_method' => 'pessoasNomeacoes',
                'target_table' => 'pessoas_nomeacoes',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
            [
                'alias' => 'financeiro_caixas',
                'file' => 'csv/financeiro_caixas.csv',
                'static_method' => 'financeiroCaixas',
                'target_table' => 'financeiro_caixas',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
            [
